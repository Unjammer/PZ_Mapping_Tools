...
public:
    ...
    const char *tileNameAt(int x, int y);
    bool setTileByName(int x, int y, const char *tileName);
    bool clearTileByName(int x, int y, const char *tileName);
    bool replaceTileByNameAt(int x, int y, const char *oldTileName,
...
public:
    ...
    LuaTileLayer *tileLayerAt(int level, const char *name);
    ...
    Tile *tileForEdit(const QString &name);
    ...
    int clearTilesByName(const char *tileName);
    int replaceTileByName(const char *oldTileName, const char *newTileName);
...
private:
    ...
    static LuaScript *fromLua(lua_State *state);
