...
public:
    ...
    static void clearScriptRunnerIfExists();
    ...
    void setScriptRunner(const std::function<void (const QString &)> &runner,
                         bool buildingEditorMode = false);
    void clearScriptRunner();
...
private:
    ...
    Ui::LuaConsole *ui;
    QString mFileName;
    std::function<void (const QString &)> mScriptRunner;
    bool mBuildingEditorMode;
};
