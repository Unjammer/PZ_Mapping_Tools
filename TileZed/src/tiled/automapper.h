...
class ObjectInputIndexName
{
public:
    QVector<ObjectGroup*> listYes;
    QVector<ObjectGroup*> listNo;
};

class ObjectInputIndex : public QMap<QString, ObjectInputIndexName>
{
public:
    QSet<QString> names;
};

class ObjectInputLayers : public QMap<QString, ObjectInputIndex>
{
public:
    QSet<QString> indexes;
    QSet<QString> names;
...
public:
    ...
    QString rulePath() const { return mRulePath; }
    QStringList inputLayerNames() const;
    QStringList outputLayerNames() const;
    int ruleCount() const { return mRulesInput.size(); }
    bool deletesTiles() const { return mDeleteTiles; }
    int automappingRadius() const { return mAutoMappingRadius; }
    bool preventsOverlappingRules() const { return mNoOverlappingRules; }
...
private:
    ...
    ObjectInputLayers mObjectInputRules;
